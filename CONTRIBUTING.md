# Contributing to Troona

A big welcome and thank you for considering contributing to Troona! It's people like you that make
Troona a great app. You can contribute in many ways, such as reporting issues, helping us improve
...
managing and developing these open source projects. In return, we will reciprocate that respect by
...
the [Troona Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this
code.
...
- Please ask first before working on new features.
- Make sure to follow the coding style and naming conventions already in use.
- If you've never contributed before,
  see [this guide](https://opensource.guide/how-to-contribute) on how to get started.

### Issues

Issues should be used to report problems with the app, request a new feature, or to discuss
potential changes before a PR is created. When you create a new Issue, a template will be loaded
that will guide you through collecting and providing the information we need to investigate.
...
save time creating and reviewing changes.
...
7. Open a PR in our repository and follow the PR template so that we can efficiently review the
   changes.

## Getting Help

Join us on Telegram at [Troona](https://t.me/+F_HMBkbgyHA2NmZk) to ask questions, get help
troubleshooting, or
just chat about the latest app updates.